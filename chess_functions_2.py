            ...
            if zetten_score:
                ...
                if m == 6:
                    ...
                    for zet in zetten_score:
                        bord_v = doe_zet_zonder_controle(
                            bord, self.kleur, zet[0], zet[1]
                        )
...
def doe_zet_zonder_controle(bord, kleur, van, naar):
    ...
    if bord[van[0]][van[1]][1] == "pion":
        if van[0] == 1 and kleur == "wit":
            volgend_bord[naar[0]][naar[1]] = ["wit", "koningin"]
        elif van[0] == 6 and kleur == "zwart":
            volgend_bord[naar[0]][naar[1]] = ["zwart", "koningin"]
        else:
