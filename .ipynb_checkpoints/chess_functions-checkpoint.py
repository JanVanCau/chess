...
def alle_geldige_zetten_score(bord, kleur):  # Waarschijnlijk sneller indien eerst functie alle_geldige_zetten oproepen, en dan scores toevoegen
                ...
                for zet in zetten:
                    ...
                    if not check_v_own:
                        ...
                        if check_v_other:
                            ...
                            if ch_mt:
                                geldige_zetten_score.append([[i, j], zet, 6]) # schaakmat
                            else:
